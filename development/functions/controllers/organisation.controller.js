...
//     to: 'admin@levls.io', // recipient
//     from: 'LEVLS. <noreply@levls.io>',
//     subject: `New organisation sign up - ${req.body.organisationName}`,
//     text: `${req.body.organisationName}, just created an account`,
//     html: `
//         <h3> Hello Admin </h3>
//         <p>A new 'Organisation created an account.</p>
//         <p>Thank You.</p>
...
//         return db.collection('usernames').doc(`${newOrg.username}`).get();
//       })
//       .then((doc) => {
//         if (doc.exists) {
...
//         const orgData = {
//           userReference: db.doc(`/users/${userId}`),
//           organisationName: db.doc(`/users/${userId}`),
//         };
//         db.doc(`organisations/${userId}`).set(orgData);
//       })
//       .then(() => {
